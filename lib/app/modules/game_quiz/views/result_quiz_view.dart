      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                if (controller.nilai == 'Konservatif')
                  Column(
                    children: [
                      Container(
                        height: 340,
                        ...
                        child: Image.asset(
                          'assets/images/konservatif_logo.png',
                  ...
                  Column(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(),
                        child: Image.asset(
                          'assets/images/moderat_logo.png',
                          height: double.infinity,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15),
                              Text(
                                'Pilihan produk investasi yang bisa kamu pilih sebagai investor moderat adalah Reksadana Campuran dan Saham Blue Chip (LQ45).',
                                textAlign: TextAlign.justify,
                                style: GoogleFonts.inter(fontSize: 14),
                              ),
                            ],
                  ...
                  Column(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(),
                        child: Image.asset(
                          'assets/images/agresif_logo.png',
                          height: double.infinity,
                          width: double.infinity,
                          fit: BoxFit.cover,
                        ),
